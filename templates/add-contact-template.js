        ...
        <div id="add-contact-interactions-container">
            ...
            <div id="add-contact-btn-placeholder"></div>
                <div id="add-contact-btn-container">
                    ...
                    <button id="add-contact-create" onclick="handleContactCreation()">Create contact <svg width="24" height="24" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
